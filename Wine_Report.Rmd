...
```{r}
reparam.wine.lm <- lm(quality ~ total.acidity + residual.sugar + chlorides + free.sulfur.dioxide + bound.sulfur.dioxide + alc.density + sulphates + color, data = wine.reparam)
vif(reparam.wine.lm)
```
